      ...
      return {
        ...
        blocks: [
          ...
          "---",
          {
            opcode: "setBorder",
            blockType: Scratch.BlockType.COMMAND,
            text: Scratch.translate("set canvas border to [WIDTH] pixels [STYLE] with color [COLOR1] and background [COLOR2]"),
            arguments: {
              STYLE: {
                type: Scratch.ArgumentType.STRING,
                menu: "borderTypes",
          ...
          },
          {
            opcode: "renderscale",
            blockType: Scratch.BlockType.COMMAND,
            text: Scratch.translate("set canvas render size to width: [X] height: [Y]"),
            arguments: {
              X: {
                type: Scratch.ArgumentType.NUMBER,
                defaultValue: 100,
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: Scratch.translate("set canvas resize rendering mode [EFFECT]"),
            arguments: {
              EFFECT: {
                type: Scratch.ArgumentType.STRING,
                menu: "RENDERMODE",
