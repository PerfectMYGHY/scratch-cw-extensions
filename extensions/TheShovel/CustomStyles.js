      ...
      return {
        ...
        blocks: [
          ...
          },
          {
            ...
            text: Scratch.translate("make a gradient with [COLOR1] and [COLOR2] at angle [ANGLE]"),
            arguments: {
              COLOR1: {
                type: Scratch.ArgumentType.COLOR,
                defaultValue: "#ff0000",
          ...
          },
          {
            ...
            opcode: "getValue",
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate("get [ITEM]"),
            arguments: {
              ITEM: {
                type: Scratch.ArgumentType.STRING,
                menu: "VALUEGET_LIST",
          ...
          "---",
          {
            ...
            opcode: "setvarpos",
            blockType: Scratch.BlockType.COMMAND,
            text: Scratch.translate("set position of variable [NAME] to x: [X] y: [Y]"),
            arguments: {
              X: {
                type: Scratch.ArgumentType.NUMBER,
                defaultValue: "0",
          ...
          },
          {
            ...
            opcode: "setlistpos",
            blockType: Scratch.BlockType.COMMAND,
            text: Scratch.translate("set position of list [NAME] to x: [X] y: [Y]"),
            arguments: {
              X: {
                type: Scratch.ArgumentType.NUMBER,
                defaultValue: "0",
