      ...
      return {
        ...
        blocks: [
          ...
          "---",
          {
            ...
            blockType: BlockType.REPORTER,
            disableMonitor: true,
            text: Scratch.translate("get headers as json"),
          },
          {
            ...
            text: Scratch.translate("get [name] from header"),
          },
          "---",
          {
          ...
          },
          {
            ...
            text: Scratch.translate("get [name] in request form"),
          },
          {
          ...
          },
          {
            ...
            text: Scratch.translate("set [path] to type [type] in request options"),
            hideFromPalette: !this.showingExtra,
          },
          {
            ...
            text: Scratch.translate("get [path] in request options"),
            hideFromPalette: !this.showingExtra,
          },
          {
            ...
            text: Scratch.translate("get type of [path] in request options"),
            hideFromPalette: !this.showingExtra,
          },
        ],
        menus: {
