      ...
      return {
        ...
        blocks: [
          ...
          "---",
          {
            opcode: "get_block",
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate("get [USER_URL] respond [RESPONSES_TYPES] split by [SPLIT]"),
            arguments: {
              USER_URL: {
          ...
          },
          {
            opcode: "delete_block",
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate("delete [USER_URL] respond [RESPONSES_TYPES] split by [SPLIT]"),
            arguments: {
              USER_URL: {
                type: Scratch.ArgumentType.STRING,
          ...
          },
          {
            opcode: "post_block",
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate("post [CONTENT_TYPE] [BODY] to [USER_URL] respond [RESPONSES_TYPES] split by [SPLIT]"),
            arguments: {
              USER_URL: {
                type: Scratch.ArgumentType.STRING,
          ...
          },
          {
            opcode: "put_block",
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate("put [CONTENT_TYPE] [BODY] to [USER_URL] respond [RESPONSES_TYPES] split by [SPLIT]"),
            arguments: {
              USER_URL: {
                type: Scratch.ArgumentType.STRING,
          ...
          },
          {
            opcode: "patch_block",
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate("patch [CONTENT_TYPE] [BODY] to [USER_URL] respond [RESPONSES_TYPES] split by [SPLIT]"),
            arguments: {
              USER_URL: {
                type: Scratch.ArgumentType.STRING,
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: Scratch.translate("open [USER_URL] in new window with width: [WIDTH] height: [HEIGHT] left: [LEFT] top: [TOP]"),
            arguments: {
              USER_URL: {
                type: Scratch.ArgumentType.STRING,
                defaultValue: "https://extensions.turbowarp.org",
