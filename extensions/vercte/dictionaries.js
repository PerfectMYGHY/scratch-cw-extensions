      ...
      return {
        ...
        blocks: [
          ...
          },
          {
            ...
            text: Scratch.translate("key [KEY] in dictionary [DICT] is defined?"),
            arguments: {
              KEY: { type: Scratch.ArgumentType.STRING, defaultValue: "bar" },
              DICT: { type: Scratch.ArgumentType.STRING, defaultValue: "foo" },
            },
...

          {
            opcode: "dict_set",
            blockType: Scratch.BlockType.COMMAND,
            text: Scratch.translate("set key [KEY] in dictionary [DICT] to [VAL]"),
            arguments: {
              KEY: { type: Scratch.ArgumentType.STRING, defaultValue: "bar" },
              DICT: { type: Scratch.ArgumentType.STRING, defaultValue: "foo" },
          ...
          },
          {
            opcode: "dict_change",
            blockType: Scratch.BlockType.COMMAND,
            text: Scratch.translate("change key [KEY] in dictionary [DICT] by [BY]"),
            arguments: {
              KEY: {
                type: Scratch.ArgumentType.STRING,
                defaultValue: "number",
